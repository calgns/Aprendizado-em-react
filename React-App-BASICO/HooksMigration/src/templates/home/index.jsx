...
export const Home = () => {
  ...
  useEffect(() => {console.log(new Date().toLocaleString('pt-br'), new Date()); handleLoadPosts(0, postsPerPage)}, [handleLoadPosts, postsPerPage]);
  ...
  return (
    <section className="section-container">
      ...
      <div className="more-container">
        {!searchValue && (<MoreBtn isD={noMorePosts} text="Load More" oC={loadMorePosts}/>)}
      </div>
    </section>
  );
}
